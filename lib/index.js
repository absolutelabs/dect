...
var _dno = require('dno');

var _dno2 = _interopRequireDefault(_dno);
...
function testMethodTimedWithTrigger(selector, eventName, timeout, trigger, failTimeout) {
  return function (target, name, descriptor) {
    ...
    var newFn = function newFn() {
      ...
      setTimeout(function () {
        console.info((0, _sizzle2.default)(selector));
        (0, _sizzle2.default)(selector)[0][eventName]();
      }, timeout);
